...
library Squad {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "Squad", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462617070000000000000000000000053717561640000000000000000000000);

  FieldLayout constant _fieldLayout =
    FieldLayout.wrap(0x0035030114200100000000000000000000000000000000000000000000000000);

  // Hex-encoded key schema of (bytes32)
  Schema constant _keySchema = Schema.wrap(0x002001005f000000000000000000000000000000000000000000000000000000);
  // Hex-encoded value schema of (address, uint256, bool, string)
  Schema constant _valueSchema = Schema.wrap(0x00350301611f60c5000000000000000000000000000000000000000000000000);
   ...
   */
  function get(bytes32 id) internal view returns (SquadData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 id) internal view returns (SquadData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   */
  function set(bytes32 id, address ownerAddress, uint256 createdAt, bool active, string memory name) internal {
    bytes memory _staticData = encodeStatic(ownerAddress, createdAt, active);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32 id, address ownerAddress, uint256 createdAt, bool active, string memory name) internal {
    bytes memory _staticData = encodeStatic(ownerAddress, createdAt, active);
   ...
   */
  function set(bytes32 id, SquadData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.ownerAddress, _table.createdAt, _table.active);
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 id, SquadData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.ownerAddress, _table.createdAt, _table.active);
  ...
  function decodeStatic(
    bytes memory _blob
  ) internal pure returns (address ownerAddress, uint256 createdAt, bool active) {
  ...
  ) internal pure returns (SquadData memory _table) {
    (_table.ownerAddress, _table.createdAt, _table.active) = decodeStatic(_staticData);
   ...
   */
  function encodeStatic(address ownerAddress, uint256 createdAt, bool active) internal pure returns (bytes memory) {
    return abi.encodePacked(ownerAddress, createdAt, active);
  }
