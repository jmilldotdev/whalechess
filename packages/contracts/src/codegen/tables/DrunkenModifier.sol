...
library DrunkenModifier {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "DrunkenModifier", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746261707000000000000000000000004472756e6b656e4d6f64696669657200);
