...
library Piece {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "Piece", typeId: RESOURCE_TABLE });`
   ...
   * @notice Get movementAbility.
   */
  function _getMovementAbility(bytes32 id) internal view returns (string memory movementAbility) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Set movementAbility.
   */
  function setMovementAbility(bytes32 id, string memory movementAbility) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Set movementAbility.
   */
  function _setMovementAbility(bytes32 id, string memory movementAbility) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Get the length of movementAbility.
   */
  function lengthMovementAbility(bytes32 id) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get the length of movementAbility.
   */
  function _lengthMovementAbility(bytes32 id) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Get an item of movementAbility.
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItemMovementAbility(bytes32 id, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function _getItemMovementAbility(bytes32 id, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Push a slice to movementAbility.
   */
  function pushMovementAbility(bytes32 id, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Push a slice to movementAbility.
   */
  function _pushMovementAbility(bytes32 id, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Pop a slice from movementAbility.
   */
  function popMovementAbility(bytes32 id) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Pop a slice from movementAbility.
   */
  function _popMovementAbility(bytes32 id) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Update a slice of movementAbility at `_index`.
   */
  function updateMovementAbility(bytes32 id, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Update a slice of movementAbility at `_index`.
   */
  function _updateMovementAbility(bytes32 id, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Get captureAbility.
   */
  function getCaptureAbility(bytes32 id) internal view returns (string memory captureAbility) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get captureAbility.
   */
  function _getCaptureAbility(bytes32 id) internal view returns (string memory captureAbility) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Set captureAbility.
   */
  function setCaptureAbility(bytes32 id, string memory captureAbility) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Set captureAbility.
   */
  function _setCaptureAbility(bytes32 id, string memory captureAbility) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Get the length of captureAbility.
   */
  function lengthCaptureAbility(bytes32 id) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get the length of captureAbility.
   */
  function _lengthCaptureAbility(bytes32 id) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Get an item of captureAbility.
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItemCaptureAbility(bytes32 id, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function _getItemCaptureAbility(bytes32 id, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Push a slice to captureAbility.
   */
  function pushCaptureAbility(bytes32 id, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Push a slice to captureAbility.
   */
  function _pushCaptureAbility(bytes32 id, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Pop a slice from captureAbility.
   */
  function popCaptureAbility(bytes32 id) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Pop a slice from captureAbility.
   */
  function _popCaptureAbility(bytes32 id) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Update a slice of captureAbility at `_index`.
   */
  function updateCaptureAbility(bytes32 id, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Update a slice of captureAbility at `_index`.
   */
  function _updateCaptureAbility(bytes32 id, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   */
  function get(bytes32 id) internal view returns (PieceData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 id) internal view returns (PieceData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
